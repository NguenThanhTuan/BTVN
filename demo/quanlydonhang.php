...
<table width="" border="1" background="">
    ...
    while($rows=mysql_fetch_array($result))
    {
        ...
        <tr>
            ...
            <td>
                <div align="left">
                    <?php echo $rows['sanpham'];?> - <a href="index.php?chitiet=<?php echo $rows['sanpham']; ?>&alias:<?php echo $rows['alias']; ?>"><?php echo $rows['tenhang']; ?></a>
                </div>
            </td>
            <td>
                <div align="left">
            ...
            <td>
                <div align="left">
                    <?php echo $rows['soluong'];?><br/><?php echo number_format($rows['giaban']);?>
                </div>
            </td>
            <td>
                <div align="left">
                    <?php echo number_format($rows['giaban']*$rows['soluong']);?>đ
                </div>
            </td>
            <td>
                <div align="left">
                    <?php echo $rows['ghichu'];?>
                </div>
            </td>
            ...
            <td>
                <div align="left">
                    <a href="index.php?action=110&del=<?php echo $rows['id'];?>">Xóa</a>
                </div>
            </td>
        </tr>
        <?php
